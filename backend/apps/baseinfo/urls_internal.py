...
urlpatterns = [
    ...
    path("v1/assessment-kits/<str:assessment_kit_id>/subjects/",commonviews.LoadAssessmentSubjectInternalApi.as_view()),
    path("maturity-level/<str:maturity_level_id>/level-competences/",assessmentkitviews.LoadLevelCompetenceInternalApi.as_view()),
    path("v1/assessment-kits/<str:assessment_kit_id>/maturity-levels/",assessmentkitviews.LoadMaturityLevelInternalApi.as_view()),
    ...
    path("v1/answer-options/",commonviews.LoadAnswerOptionWithlistQuestionInternalApi.as_view()),
]
