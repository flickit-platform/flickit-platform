...
class UserExpertGroupsApiView(APIView):
    ...
    def get(self, request):
        ...
        serializer = expertgroupserializers.ExpertGroupSerilizer(paginated_queryset, many=True,
...
class ExpertGroupAccessViewSet(mixins.RetrieveModelMixin,
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        if not result:
            return Response({"message": "The owner of the expert group can not be removed"},
