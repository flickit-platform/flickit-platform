# Generated by Django 4.1 on 2024-03-04 11:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment_kit', models.ForeignKey(db_column='kit_id', on_delete=django.db.models.deletion.CASCADE, related_name='assessment_subjects', to='baseinfo.assessmentkit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modification_date', models.DateTimeField(auto_now=True, db_column='last_modification_time')),
                ('ref_num', models.UUIDField()),
                ('assessment_kit', models.ForeignKey(db_column='kit_id', on_delete=django.db.models.deletion.CASCADE, related_name='maturity_levels', to='baseinfo.assessmentkit')),
            ...
            options={
                ...
                'unique_together': {('index', 'assessment_kit'), ('title', 'assessment_kit'), ('code', 'assessment_kit'), ('value', 'assessment_kit')},
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_num', models.UUIDField()),
                ('assessment_kit', models.ForeignKey(db_column='kit_id', on_delete=django.db.models.deletion.CASCADE, related_name='quality_attributes', to='baseinfo.assessmentkit')),
            ...
            options={
                ...
                'unique_together': {('code', 'assessment_subject'), ('title', 'assessment_kit'), ('code', 'assessment_kit'), ('index', 'assessment_subject')},
            },
        ),
        migrations.CreateModel(
            name='Question',
            fields=[
                ...
                ('ref_num', models.UUIDField()),
                ('assessment_kit', models.ForeignKey(db_column='kit_id', on_delete=django.db.models.deletion.CASCADE, related_name='question', to='baseinfo.assessmentkit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.PositiveIntegerField()),
                ('ref_num', models.UUIDField()),
                ('assessment_kit', models.ForeignKey(db_column='kit_id', on_delete=django.db.models.deletion.CASCADE, related_name='questionnaires', to='baseinfo.assessmentkit')),
            ...
            options={
                ...
                'unique_together': {('index', 'assessment_kit'), ('title', 'assessment_kit'), ('code', 'assessment_kit')},
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='assessment_kit',
            field=models.ForeignKey(db_column='kit_id', on_delete=django.db.models.deletion.CASCADE, related_name='answer_templates', to='baseinfo.assessmentkit'),
        ),
        migrations.AddField(
            model_name='answertemplate',
            name='created_by',
            field=models.ForeignKey(db_column='created_by', on_delete=django.db.models.deletion.CASCADE, related_name='answer_templates', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='answertemplate',
            name='last_modified_by',
