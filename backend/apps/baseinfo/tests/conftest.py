...
def init_data():
    def do_init_data():
        ...
        option_value = []
        option_value.append(baker.make(OptionValue, option = answer_template[0], value = 0.5 , question_impact = question_impacts[0]))
        option_value.append(baker.make(OptionValue, option = answer_template[1], value = 0.5 , question_impact = question_impacts[1]))
